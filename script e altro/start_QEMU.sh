...
MACHINE_OPTS="-enable-kvm -m 512M -kernel $KERNEL_PATH -initrd $INITRD -append 'root=/dev/mem' -machine q35 -device pcie-root-port,id=rp1,chassis=1,slot=1 -device disp,bus=rp1"
